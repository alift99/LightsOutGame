...
module led_out_9 (
  ...
  display_encoder_17 display_encoder (
  ...
  color_adapter_18 color_adapter0 (
    .clk(clk),
    .rst(rst),
  ...
  color_adapter_18 color_adapter1 (
    .clk(clk),
    .rst(rst),
  ...
  color_adapter_18 color_adapter2 (
    .clk(clk),
    .rst(rst),
  ...
  color_adapter_18 color_adapter3 (
    .clk(clk),
    .rst(rst),
