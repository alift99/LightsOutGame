...
module led_out_11 (
  ...
  display_encoder_19 display_encoder (
  ...
  color_adapter_20 color_adapter0 (
    .clk(clk),
    .rst(rst),
  ...
  color_adapter_20 color_adapter1 (
    .clk(clk),
    .rst(rst),
  ...
  color_adapter_20 color_adapter2 (
    .clk(clk),
    .rst(rst),
  ...
  color_adapter_20 color_adapter3 (
    .clk(clk),
    .rst(rst),
